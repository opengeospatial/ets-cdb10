...
public class VerifyGTModelMaterialStructureTests extends StructureTestFixture<GTModelMaterialStructureTests> {
	...
	public void verifyModelMaterialFile_invalid() throws IOException {
		...
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "asdf")));
	...
	public void verifyModelMaterialFile_invalidDataset() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D211_S001_T001_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_invalidExtension() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S001_T001_L10_AB_1.txt")));
	...
	public void verifyModelMaterialFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S1_T001_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_SABC_T001_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_badCS1() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S003_T255_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S001_T1_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S001_TABC_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_badCS2() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S002_T255_L10_AB_1.tif")));
	...
	public void verifyModelMaterialFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1", "D504_S001_T001_L10_AB_1.tif")));
