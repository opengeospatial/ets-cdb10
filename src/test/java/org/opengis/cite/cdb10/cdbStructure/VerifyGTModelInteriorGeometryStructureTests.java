...
public class VerifyGTModelInteriorGeometryStructureTests
		extends StructureTestFixture<GTModelInteriorGeometryStructureTests> {
	...
	public void verifyInteriorGeometryFile_invalid() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "asdf")));
	...
	public void verifyInteriorGeometryFile_invalidDataset() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D501_S001_T001_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_invalidExtension() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T001_L20_12345_001_amodelname.txt")));
	...
	public void verifyInteriorGeometryFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S1_T001_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_SABC_T001_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badCS1() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S002_T001_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T1_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_TABC_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badCS2() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T000_L20_12345_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badFCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T001_L20_45_001_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badFSCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T001_L20_12345_1_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badFSCType() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T001_L20_12345_ABC_amodelname.flt")));
	...
	public void verifyInteriorGeometryFile_badMODLLength() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture", "A_Extraction", "010_Mine", "L20",
	...
	public void verifyInteriorGeometryFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture",
				"A_Extraction", "010_Mine", "L20", "D506_S001_T001_L20_12345_001_amodelname.flt")));
