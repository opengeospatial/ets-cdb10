...
public class VerifyGTModelInteriorMaterialStructureTests
		extends StructureTestFixture<GTModelInteriorMaterialStructureTests> {
	...
	public void verifyModelInteriorMaterialFile_invalid() throws IOException {
		...
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "asdf")));
	...
	public void verifyModelInteriorMaterialFile_invalidDataset() throws IOException {
		...
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D211_S001_T001_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_invalidExtension() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S001_T001_L10_AB_1.txt")));
	...
	public void verifyModelInteriorMaterialFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S1_T001_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_SABC_T001_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_badCS1() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S003_T001_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S001_T1_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S001_TABC_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_badCS2() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S002_T255_L10_AB_1.tif")));
	...
	public void verifyModelInteriorMaterialFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1", "D509_S001_T001_L10_AB_1.tif")));
