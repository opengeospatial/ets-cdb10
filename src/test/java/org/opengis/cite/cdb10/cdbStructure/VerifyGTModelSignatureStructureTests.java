...
public class VerifyGTModelSignatureStructureTests extends StructureTestFixture<GTModelSignatureStructureTests> {
	...
	public void verifyGeometrySignatureFile_invalid() throws IOException {
		...
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "502_GTModelSignature", "A_Culture", "A_Extraction", "010_Mine", "L10", "asdf")));
	...
	public void verifyGeometrySignatureFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S1_T001_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_SABC_T001_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badCS1() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S000_T001_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T1_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_TABC_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badCS2() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T033_L10_12345_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badFCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T001_L10_45_001_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badFSCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T001_L10_12345_1_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badFSCType() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T001_L10_12345_ABC_amodelname.flt")));
	...
	public void verifyGeometrySignatureFile_badMODLLength() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture", "A_Extraction", "010_Mine", "L10",
	...
	public void verifyGeometrySignatureFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture",
				"A_Extraction", "010_Mine", "L10", "D512_S001_T001_L10_12345_001_amodelname.flt")));
