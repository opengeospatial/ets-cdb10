...
public class VerifyGTModelStructureTests extends StructureTestFixture<GTModelStructureTests> {
	...
	public void verifyCategory_WrongCategory() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "B_Culture")));
	...
	public void verifyCategory_WrongLabel() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Hydrography")));
	...
	public void verifyCategory_UnspecifiedCategory() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "Z_Culture")));
	...
	public void verifyCategory_UnspecifiedLabel() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Bogus")));
	...
	public void verifyCategory_Good500() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture")));
	...
	public void verifyCategory_Good502() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture")));
	...
	public void verifyCategory_Good503() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture")));
	...
	public void verifyCategory_Good510() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "510_GTModelGeometry", "A_Culture")));
	...
	public void verifyCategory_Good506() throws IOException {
		// setup
		Files
			.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture")));
	...
	public void verifyCategory_Good508() throws IOException {
		...
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "508_GTModelInteriorDescriptor", "A_Culture")));
	...
	public void verifySubcategory_WrongCategory() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "B_Extraction")));
	...
	public void verifySubcategory_WrongLabel() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Disposal")));
	...
	public void verifySubcategory_UnspecifiedCategory() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "ZZZZ_Extraction")));
	...
	public void verifySubcategory_UnspecifiedLabel() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Bogus")));
	...
	public void verifySubcategory_Good500() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction")));
	...
	public void verifySubcategory_Good502() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture", "A_Extraction")));
	...
	public void verifySubcategory_Good503() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture", "A_Extraction")));
	...
	public void verifySubcategory_Good510() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "510_GTModelGeometry", "A_Culture", "A_Extraction")));
	...
	public void verifySubcategory_Good506() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture", "A_Extraction")));
	...
	public void verifySubcategory_Good508() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "508_GTModelInteriorDescriptor", "A_Culture", "A_Extraction")));
	...
	public void verifyFeatureType_WrongCategory() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "001_Mine")));
	...
	public void verifyFeatureType_WrongLabel() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Quarry_Wall")));
	...
	public void verifyFeatureType_UnspecifiedCategory() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "999_Mine")));
	...
	public void verifyFeatureType_UnspecifiedLabel() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Bogus")));
	...
	public void verifyFeatureType_Good500() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyFeatureType_Good510() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "510_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyFeatureType_Good502() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyFeatureType_Good503() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyFeatureType_Good506() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyFeatureType_Good508() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "508_GTModelInteriorDescriptor", "A_Culture", "A_Extraction", "010_Mine")));
	...
	public void verifyLOD_BadLevel() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine", "LA")));
	...
	public void verifyLOD_TooHigh() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine", "L99")));
	...
	public void verifyLOD_NoPadding() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine", "L9")));
	...
	public void verifyLOD_Good500() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "500_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyLOD_Good510() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "510_GTModelGeometry", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyLOD_Good502() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "502_GTModelSignature", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyLOD_Good503() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyLOD_Good506() throws IOException {
		...
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "506_GTModelInteriorGeometry", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyLOD_Good508() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(
				Paths.get("GTModel", "508_GTModelInteriorDescriptor", "A_Culture", "A_Extraction", "010_Mine", "L23")));
	...
	public void verifyTNAMPrefix_TooLong() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "ABC")));
	...
	public void verifyTNAMPrefix_WrongCase() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "a")));
	...
	public void verifyTNAMPrefix_Good501() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "501_GTModelTexture", "A")));
	...
	public void verifyTNAMPrefix_Good504() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A")));
	...
	public void verifyTNAMPrefix_Good505() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "505_GTModelCMT", "A")));
	...
	public void verifyTNAMPrefix_Good507() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "507_GTModelInteriorTexture", "A")));
	...
	public void verifyTNAMPrefix_Good509() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "509_GTModelInteriorMaterial", "A")));
	...
	public void verifyTNAMPrefix_Good513() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "513_GTModelInteriorCMT", "A")));
	...
	public void verifyTNAMSecond_TooLong() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "BCD")));
	...
	public void verifyTNAMSecond_WrongCase() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "b")));
	...
	public void verifyTNAMSecond_Good501() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "501_GTModelTexture", "A", "B")));
	...
	public void verifyTNAMSecond_Good504() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B")));
	...
	public void verifyTNAMSecond_Good505() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "505_GTModelCMT", "A", "B")));
	...
	public void verifyTNAMSecond_Good507() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "507_GTModelInteriorTexture", "A", "B")));
	...
	public void verifyTNAMSecond_Good509() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B")));
	...
	public void verifyTNAMSecond_Good513() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "513_GTModelInteriorCMT", "A", "B")));
	...
	public void verifyTNAM_TooShort() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "A")));
	...
	public void verifyTNAM_TooLong() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")));
	...
	public void verifyTNAM_WrongChars() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "$$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")));
	...
	public void verifyTNAM_Mismatch() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AC_1")));
	...
	public void verifyTNAM_Good501() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "501_GTModelTexture", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good504() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "504_GTModelMaterial", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good505() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "505_GTModelCMT", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good507() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "507_GTModelInteriorTexture", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good509() throws IOException {
		// setup
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "509_GTModelInteriorMaterial", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good511() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1")));
	...
	public void verifyTNAM_Good513() throws IOException {
		// setup
		Files
			.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "513_GTModelInteriorCMT", "A", "B", "AB_1")));
