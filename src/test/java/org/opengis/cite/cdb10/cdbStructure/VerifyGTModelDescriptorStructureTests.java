...
public class VerifyGTModelDescriptorStructureTests extends StructureTestFixture<GTModelDescriptorStructureTests> {
	...
	public void verifyDescriptorFile_invalid() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture", "A_Extraction", "010_Mine", "asdf")));
	...
	public void verifyDescriptorFile_invalidExtension() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_12345_001_amodelname.txt")));
	...
	public void verifyDescriptorFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S1_T001_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_SABC_T001_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badCS1() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S002_T001_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T1_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_TABC_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badCS2() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T002_12345_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badFCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_45_001_amodelname.xml")));
	...
	public void verifyDescriptorFile_badFSCLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_12345_1_amodelname.xml")));
	...
	public void verifyDescriptorFile_badFSCType() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_12345_ABC_amodelname.xml")));
	...
	public void verifyDescriptorFile_badMODLLength() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_12345_001_amodelnameamodelnameamodelnameamodelname.xml")));
	...
	public void verifyDescriptorFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root.resolve(Paths.get("GTModel", "503_GTModelDescriptor", "A_Culture",
				"A_Extraction", "010_Mine", "D503_S001_T001_12345_001_amodelname.xml")));
