...
public class VerifyGTModelTextureStructureTests extends StructureTestFixture<GTModelTextureStructureTests> {
	...
	public void verifyModelTextureFile_invalid() throws IOException {
		...
		Files.createDirectories(
				this.cdb_root.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "asdf")));
	...
	public void verifyModelTextureFile_invalidDataset() throws IOException {
		...
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D211_S002_T001_L10_AB_1.rgb")));
	...
	public void verifyModelTextureFile_invalidExtension() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_S002_T001_L10_AB_1.txt")));
	...
	public void verifyModelTextureFile_badCS1Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_S1_T001_L10_AB_1.rgb")));
	...
	public void verifyModelTextureFile_badCS1Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_SABC_T001_L10_AB_1.rgb")));
	...
	public void verifyModelTextureFile_badCS2Length() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_S002_T1_L10_AB_1.rgb")));
	...
	public void verifyModelTextureFile_badCS2Type() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_S002_TABC_L10_AB_1.rgb")));
	...
	public void verifyModelTextureFile_Good() throws IOException {
		// setup
		Files.createDirectories(this.cdb_root
			.resolve(Paths.get("GTModel", "511_GTModelTexture", "A", "B", "AB_1", "D511_S002_T001_L10_AB_1.rgb")));
