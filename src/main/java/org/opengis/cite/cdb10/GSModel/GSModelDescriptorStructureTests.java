...
/**
 * <p>
 * GSModelDescriptorStructureTests class.
 * </p>
 *
 */
public class GSModelDescriptorStructureTests extends Capability1Tests {

	/** Constant <code>DATASET_CODE="303"</code> */
	public static final String DATASET_CODE = "303";

	/** Constant <code>DATASET_DIRECTORY="303_GSModelDescriptor"</code> */
	public static final String DATASET_DIRECTORY = "303_GSModelDescriptor";
	...
	/**
	 * Validates that GSModelDescriptor files are ZIP archive files with no compression,
	 * and limited to 32 Megabytes (not 32 Mebibytes).
	 * @throws java.io.IOException Error reading from CDB
	 */
