...
public class GSModelInteriorGeometryStructureTests extends Capability1Tests {
	...
	/** Constant <code>DATASET_CODE="305"</code> */
	public static final String DATASET_CODE = "305";

	/** Constant <code>DATASET_DIRECTORY="305_GSModelInteriorGeometry"</code> */
	...
	/**
	 * Validates that GSModelInteriorGeometry files are ZIP archive files with no
	...
	/**
	 * Validates that GSModelInteriorGeometry entries inside ZIP archive follow naming
	 * conventions.
	 * @throws java.io.IOException Error reading from CDB
	 */
