...
/**
 * <p>
 * GSModelGeometryStructureTests class.
 * </p>
 *
 */
public class GSModelGeometryStructureTests extends Capability1Tests {

	/** Constant <code>DATASET_CODE="300"</code> */
	public static final String DATASET_CODE = "300";

	/** Constant <code>DATASET_DIRECTORY="300_GSModelGeometry"</code> */
	...
	/**
	 * Validates that GSModelGeometry files are ZIP archive files with no compression, and
	 * limited to 32 MB.
	 * @throws java.io.IOException Error reading from CDB
	 */
