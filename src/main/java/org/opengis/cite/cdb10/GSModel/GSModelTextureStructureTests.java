...
/**
 * <p>
 * GSModelTextureStructureTests class.
 * </p>
 *
 */
public class GSModelTextureStructureTests extends Capability1Tests {

	/** Constant <code>DATASET_CODE="301"</code> */
	public static final String DATASET_CODE = "301";

	/** Constant <code>DATASET_DIRECTORY="301_GSModelTexture"</code> */
	...
	/**
	 * Validates that GSModelTexture files are ZIP archive files with no compression, and
	 * limited to 32 MB.
	 * @throws java.io.IOException Error reading from CDB
	 */
	...
	/**
	 * Validates that GSModelTexture entries inside ZIP archive follow naming conventions.
	 * @throws java.io.IOException Error reading from CDB
	 */
