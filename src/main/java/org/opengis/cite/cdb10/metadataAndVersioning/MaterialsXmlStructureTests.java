...
public class MaterialsXmlStructureTests extends Capability2Tests {
	...
	/**
	 * If the Materials XML and Schema files exist, then verify the XML against the
	 * schema.
	...
	public void verifyMaterialsXmlAgainstSchema() throws IOException, SAXException {
		...
		Assert.assertEquals(errors, "",
				materials.getXmlFileName() + " does not validate against its XML Schema file. Errors: " + errors);
	}
	...
	/**
	 * <p>
	 * verifyMaterialsXmlAllBaseMaterialElementsHaveAChildNodeName.
	 * </p>
	 */
	@Test(description = "OGC 15-113r3, A.1.19, Test 76")
	public void verifyMaterialsXmlAllBaseMaterialElementsHaveAChildNodeName() {
		...
		Assert.assertEquals(baseMaterialNodes.getLength(), 0,
				"Materials.xml element \"<Base_Material>\" requires a child element \"<Name>\".");
	}
