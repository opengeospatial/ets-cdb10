...
public class VersionXmlStructureTests extends Capability2Tests {
	 ...
	 * @throws java.io.IOException Error reading XML or XSD file
	 * @throws org.xml.sax.SAXException Error parsing XML or XSD file
	 */
	...
	public void verifyVersionXmlAgainstSchema() throws IOException, SAXException {
		...
		Assert.assertEquals(errors, "",
				version.getXmlFileName() + " does not validate against its XML Schema file. Errors: " + errors);
	}
	...
	/**
	 * Check that the "Specification" element has valid values for the "version"
	 * attribute.
	 */
